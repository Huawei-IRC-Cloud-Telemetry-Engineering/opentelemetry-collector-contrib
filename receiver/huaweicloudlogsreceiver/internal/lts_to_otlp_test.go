...
func TestExtractTimestamp(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			log:          "2020-07-25/14:44:43 this <HighLightTag>log</HighLightTag> is Error NO 2",
		...
		{
			name:          "No Timestamp",
			log:           "this <HighLightTag>log</HighLightTag> is Error NO 2",
			expectedError: true,
		},
		{
			name:          "Empty Log",
		...
		},
		{
			...
			log:           "2020-07-25/14:44 this <HighLightTag>log</HighLightTag> is Error NO 2",
			expectedError: true,
		},
	}
