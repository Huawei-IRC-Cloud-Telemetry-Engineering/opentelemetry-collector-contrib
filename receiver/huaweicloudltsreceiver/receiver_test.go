...
import (
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/receiver/huaweicloudltsreceiver/internal/mocks"
)
...
func TestNewReceiver(t *testing.T) {
	...
	mr := newhuaweicloudltsreceiver(receivertest.NewNopSettings(), cfg, new(consumertest.LogsSink))
	assert.NotNil(t, mr)
}
...
func TestPollLogsAndConsumeSuccess(t *testing.T) {
	...
	receiver := newhuaweicloudltsreceiver(receivertest.NewNopSettings(), &Config{}, next)
	receiver.client = mc
