...
import (
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/receiver/huaweicloudltsreceiver/internal/metadata"
)
...
func createLogsReceiver(
	...
	return newhuaweicloudltsreceiver(params, cfg.(*Config), next), nil
