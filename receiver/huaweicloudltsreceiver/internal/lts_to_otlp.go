...
package internal // import "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/huaweicloudltsreceiver/internal"
...
func ConvertLTSLogsToOTLP(projectID, regionID, groupID, streamID string, ltsLogs []model.LogContents) plog.Logs {
	logs := plog.NewLogs()
	...
	resourceAttr.PutStr("stream.id", streamID)
